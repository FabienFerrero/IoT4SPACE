...
#define SLEEPMINUTES 3

// Minimum elevation for satellite
#define MINELEVATION 25
...
static byte networkKey[] = { 0x2A, 0x47, 0x21, 0x58, 0x76, 0xB2, 0x0A, 0xC5, 0x42, 0x47, 0x96, 0xCF, 0x93, 0x12, 0x0E, 0xC6 }; //relay5
...
static byte appKey[] = { 0xB0, 0x29, 0xD5, 0x22, 0xF9, 0xC6, 0xF5, 0xA2, 0xD7, 0xC2, 0x89, 0x8A, 0xE9, 0x31, 0xCC, 0xCE };//relay5
...
static byte deviceAddress[] = { 0x26, 0x01, 0x35, 0x2D };//relay5
...
void initialize_tle() {
  ...
  char tle_line1[] = "1 46492U 20068G   20322.92843805 +.00000224 +00000-0 +20887-4 0  9996";
  char tle_line2[] = "2 46492 097.6735 255.9760 0020839 071.4880 288.8606 15.03503645007555";

// Write TLE to EEPROM
   EEPROM.put(0,tle_line1);
   EEPROM.put(69,tle_line2); 
