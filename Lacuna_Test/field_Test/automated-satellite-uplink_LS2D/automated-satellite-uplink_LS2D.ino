...
//static byte networkKey[] = { 0x32, 0x49, 0x9B, 0xCB, 0x16, 0x92, 0xD4, 0x05, 0xA9, 0xA5, 0xC7, 0x1E, 0x4C, 0xD3, 0xC6, 0x92 }; //relay
...
//static byte appKey[] = { 0x41, 0x19, 0xE1, 0x9E, 0x74, 0xC2, 0xE7, 0x5C, 0x22, 0xD0, 0x1D, 0x49, 0xA5, 0xA0, 0xF0, 0x15 };//relay
...
//static byte deviceAddress[] = { 0x26, 0x01, 0x3A, 0x9A };//relay
