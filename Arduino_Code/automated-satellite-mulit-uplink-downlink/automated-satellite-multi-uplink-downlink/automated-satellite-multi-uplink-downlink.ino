...
#define OFFSET 700 // additional time offset in ms to  limit interference for multiple devices
#define BEACON_MODE 1 //Activate beacon reception
#define LS3_UP 868300000; // uplink freq for LS3 measurement, must be a loraWan channel
