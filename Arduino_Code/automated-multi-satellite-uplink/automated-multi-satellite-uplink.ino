...
// 
#define INTERVAL 10       // 10 second
#define NUMTX 40


// Sleep time between periodic GPS checks (and TTN updates)
#define SLEEPMINUTES 30   // 30mn default

// Minimum elevation for satellite
#define MINELEVATION 18       // Test also low orbit passages
...
//#define UPDATE // automatic TLE update, only for Sat 2
// #define FAKEPASS
// #define DEBUGSLEEP   //Comment out for production
#define OFFSET 10 // additional time offset to  limit interference for multiple devices
    ...
    byte fix = updategps();
      ...
      if (fix) {
          ...
          if (start3<start) {
            start=start3;
            duration=duration3;
            initialize_tle(3);   // Sat 1 is the first one to come
            nextsat=3;
            }
...
// Please update manually TLE
 ...
 // TLE data sat1                  
  char tle_ls1_1[] = "1 44109U 19018AF  21009.75167113  .00002743  00000-0  87130-4 0  9999";
  char tle_ls1_2[] = "2 44109  97.4446  86.2184 0056783 196.6893 163.2482 15.31987795 99159"; 
  
 // TLE data sat2                   
  char tle_ls2d_1[] = "1 46492U 20068G   21023.82704123  .00000686  00000-0  54524-4 0  9990";
  char tle_ls2d_2[] = "2 46492  97.6837 322.3584 0017776 199.8606 250.7638 15.03659886 17607";   

  // TLE data sat3                   
  char tle_ls2c_1[] = "1 46913U 20081J   21007.30860201  .00000279  00000-0  28718-4 0  9992";
  char tle_ls2c_2[] = "2 46913  36.9045  99.3609 0008891 116.5841 243.5811 14.99258587  8459";   
